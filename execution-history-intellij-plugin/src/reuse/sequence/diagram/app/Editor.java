package reuse.sequence.diagram.app;

import org.apache.log4j.Logger;
import reuse.sequence.diagram.Model;
import reuse.sequence.diagram.ModelTextEvent;
import reuse.sequence.diagram.ModelTextListener;
...
public class Editor extends JPanel implements DocumentListener, ModelTextListener {
    ...
    public Editor(Model model) {
        ...
        _bundle = ResourceBundle.getBundle("reuse.sequence.props");
