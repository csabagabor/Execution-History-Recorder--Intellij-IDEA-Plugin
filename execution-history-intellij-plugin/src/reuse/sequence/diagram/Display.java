...
import reuse.sequence.config.ConfigListener;
...
public class Display extends JComponent implements ModelTextListener, Scrollable, ConfigListener {
    ...
    public String getToolTipText(MouseEvent event) {
        ScreenObject screenObject = _diagram.findScreenObjectByXY((int)(event.getX() / scale), (int)(event.getY() / scale));
...
//        return false;
    ...
    private class DisplayMouseAdapter extends MouseAdapter {
        ...
        public void mouseReleased(MouseEvent e) {
            ...
            ScreenObject screenObject = _diagram.findScreenObjectByXY((int) (e.getX() / scale), (int) (e.getY() / scale));
            if (screenObject == null)
                return;
