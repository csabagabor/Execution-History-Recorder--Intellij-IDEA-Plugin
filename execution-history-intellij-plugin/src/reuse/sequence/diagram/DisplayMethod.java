...
public class DisplayMethod extends ScreenObject {
    ...
    public void paint(Graphics2D g2) {
        ...
        Color color = isSelected() ? configuration.SELECTED_METHOD_BAR_COLOR : configuration.METHOD_BAR_COLOR;

        try {
            if (!isSelected() && _objectInfo.hasAttribute("highlight:true")) {
                color = JBColor.RED;
            }
        } catch (Exception e) {
